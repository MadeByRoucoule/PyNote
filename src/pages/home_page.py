...
class HomePage(CTkFrame):
    def __init__(self, master, pronote_script, settings_script, *args, **kwargs):
        ...
        self.notes_graph_tab_button.grid(row=3, column=0, pady=(10, 0), sticky="ew")
    ...
    def show_notes_graph_tab(self):
        ...
        subjects = list(set(grade["subject"] for grade in self.pronote_client["periods"][periods.index(self.graph_period_option_menu.get())]["grades"]))
